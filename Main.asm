...
;
; File: Project 3: Sprite Position on the Map
;===============================================================================
;===============================================================================
...
Sprite_Setup
        ...
        jsr PlayerInit                  ; Setup sprite colors and position them
        lda #%00000011                  ; Turn on sprites 0-3
        sta VIC_SPRITE_ENABLE
...
;        jsr UpdateTimers
        jsr UpdateScroll                ; Which way are we scrolling?
...
incbin "yoursprite.spt",1,6,true         ; Idle
